...
class SwitchOrganCommand extends HormonesCommand{
	...
	public function execute(CommandSender $sender, $commandLabel, array $args){
		...
		else$targetPlayer = $sender;
		$sender->getServer()->getScheduler()->scheduleAsyncTask(new FindOrganicTissueTask($this->getPlugin()->getCredentials(), $targetPlayer, $organName, $organId));
		return true;
	}
}
